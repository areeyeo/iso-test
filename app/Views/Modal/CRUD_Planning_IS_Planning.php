<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <form class="mb-3" id="form_crud_planning" action="javascript:void(0)" method="post"
        ...
        <div class="form-group mt-2">
          <h6>Project Name</h6>
          <input class="form-control gray-text" type="text" placeholder="Text..." name="project_name"
          ...
          <div class="col-6">
            <div class="form-group">
              ...
              <div class="input-group date" id="start_date" data-target-input="nearest">
                <input type="text" class="form-control datetimepicker-input gray-text" data-target="#start_date"
          ...
          <div class="col-6">
            <div class="form-group">
              ...
              <div class="input-group date" id="end_date" data-target-input="nearest">
                <input type="text" class="form-control datetimepicker-input gray-text" data-target="#end_date"
