                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Last Name ..." id="last" name="last" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control gray-text" name="group_select" id="group_select">
                                    <?php foreach ($data_group as $item) : ?>
                                        <option value="<?= $item['id_group'] ?>" id="<?= $item['id_group'] ?>"><?= $item['name_group'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control gray-text" name="role_select" id="role_select">
                                    <?php foreach ($data_role as $role) : ?>
                                        <option value="<?= $role['id_role'] ?>" id="<?= $role['id_role'] ?>"><?= $role['name_role'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row" id="date_time" name="date_time">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Name ..." id="create_date" name="create_date" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Update Date Time</label>
                                <input type="text" class="form-control" placeholder="Enter Last Name ..." id="update_date" name="update_date" disabled>
                            </div>
                        </div>
                    </div>
