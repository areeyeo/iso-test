<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form class="mb-3" id="form_crud_risk_context" action="javascript:void(0)" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group mt-3 col-6">
                        ...
                        <input class="form-control gray-text" type="text" placeholder="Text..." name="rtp_context_no" id="rtp_context_no" readonly></input>
                    </div>
                </div>
...
<script>
    $("#form_crud_risk_context").on('submit', function(e) {
        e.preventDefault();
        const urlRouteInput = document.getElementById("url_route");
        action_(urlRouteInput.value, 'form_crud_risk_context');
    });
</script>