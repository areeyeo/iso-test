        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" active>IS Policy</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <script>
    function getTableData() {
      ...
      $('#example1').DataTable({
        ...
        'serverSide': true,
        'ajax': {
          'url': "<?php echo site_url('leadership/policy/find_data/'); ?>" + data_context.id_version,
          'type': 'GET',
          'dataSrc': 'data',
        },
        "responsive": true,
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" href="#"
                      onclick="confirm_Alert('You want to copy data ${number_index} ?', 'leadership/policy/copydata/${row.id_}/${number_index}')">Copy</a>
                  <a class="dropdown-item" href="#"
                      onclick="confirm_Alert('You want to delete data ${number_index} ?', 'leadership/policy/delete/${row.id_}/${row.id_file}/${number_index}')">Delete</a>
              ...
              <div class="dropdown-divider"></div>
                <div class="dropdown-submenu">
                    ...
                    <div class="dropdown-menu right-menu-table">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"
                            onclick="confirm_Alert('You want to delete the data file ${number_index} ?', 'leadership/policy/delete_file/${row.id_}/${row.id_file}/${number_index}')">Delete
                            File</a>
                    </div>
                </div>`;
            }
  ...
  <script>
    function load_modal(check, data_encode) {
      ...
      if (check == '1') {
        ...
        $(".modal-body #url_route").val('leadership/policy/store/' + element.id_version);
      } else if (check == '3') {
        //--show modal edit--//
        Requirement_Modal.style.display = "none";
        CRUD_File_UploadOnly.style.display = "block";
        ...
        $(".modal-body #id_").val(rowData.id_policy);
        $(".modal-body #url_route").val('leadership/policy/edit');
      } else if (check == '4') {
