                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton${index}">
                            ...
                            <li><a class="dropdown-item"
                                onclick="confirm_Alert('Do you want to delete Risk Option <?= $risk['options'] ?> ?', 'planning/risk_Criteria_Context_Risk_Option/delete/<?= $risk['id_risk_options_context'] ?>')">Delete</a>
                            </li>
                            <li>
...
<script>
  function load_modal(check, check_type, data_encode) {
    ...
    if (check == '1') {
      ...
      $(".modal-body #url_route").val("planning/risk_Criteria_Context_Risk_Option/create");
    } else if (check == '2') {
      modal_crud_criteria_risk_option.style.display = "block";
      $(".modal-body #riskoption").val(risk_options[check_type]['options']);
      $(".modal-body #description").val(risk_options[check_type]['description']);
      $(".modal-body #url_route").val("planning/risk_Criteria_Context_Risk_Option/edit/" + risk_options[check_type]['id_risk_options_context']);
    }
  }
</script>
<script>
